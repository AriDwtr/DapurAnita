        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('rekening.update', $edit_rek->id_rekening) }}" method="post" autocomplete="false">
                            @csrf
                            @method('put')
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama_rek"
                                	...
                                	is-invalid
                                @enderror"
                                    id="exampleInputEmail1" value="{{ $edit_rek->nama_rek }}" placeholder="Nama Pemilik Rekening" autocomplete="false">
                                @error('nama_rek')
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="jenis_rek" id="exampleFormControlSelect1">
                                    <option value="bni" {{ $edit_rek->jenis_rekening=="bni" ? 'selected' : '' }}>BNI</option>
                                    <option value="bca" {{ $edit_rek->jenis_rekening=="bca" ? 'selected' : '' }}>BCA</option>
                                    <option value="bri" {{ $edit_rek->jenis_rekening=="bri" ? 'selected' : '' }}>BRI</option>
                                    <option value="mandiri" {{ $edit_rek->jenis_rekening=="mandiri" ? 'selected' : '' }}>MANDIRI</option>
                                    <option value="bsi" {{ $edit_rek->jenis_rekening=="bsi" ? 'selected' : '' }}>BSI</option>
                                </select>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="number" name="nomor_rek"
                                	...
                                	is-invalid
                                @enderror"
                                    id="exampleInputEmail1" placeholder="Nomor Rekening" value="{{ $edit_rek->no_rek }}" >
                                @error('nomor_rek')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            <button type="submit" class="btn btn-de-primary">Perbaharui Rekening</button>
