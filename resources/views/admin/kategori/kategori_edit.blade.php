                ...
                <div class="page-title-box">
                    <div class="row">
                        <div class="col align-self-center">
                            <h4 class="page-title pb-md-0">Edit Kategori Produk</h4>
                            <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('kategori.update', $edit->id_kategori) }}" method="post" autocomplete="false">
                            @csrf
                            @method('put')
                            <div class="mb-3">
                                ...
                                <input type="text" name="kategori"
                                	...
                                	is-invalid
                                @enderror"
                                    id="exampleInputEmail1" placeholder="Nama Kategori" value="{{ $edit->nama_kategori }}" autocomplete="false">
                                @error('kategori')
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="deskripsi_kategori"
                                    ...
                                    is-invalid
                                @enderror"
                                    id="" cols="20" rows="5" placeholder="Deskripsi Kategori">{{ $edit->deskripsi_kategori }}</textarea>
                                @error('deskirpsi_kategori')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            <button type="submit" class="btn btn-de-primary">Perbaharui Kategori</button>
