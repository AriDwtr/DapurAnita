                ...
                <div class="page-title-box">
                    <div class="row">
                        <div class="col align-self-center">
                            <h4 class="page-title pb-md-0">Edit Produk</h4>
                            <ol class="breadcrumb">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-header">
                            <h4 class="card-title">Edit Produk {{ Str::title($produk->nama_produk) }}</h4>
                            ...
                            <form action="{{ route('produk.update', $produk->id_produk) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number"
                                                ...
                                                name="stok_produk" value="{{ $produk->stok }}" placeholder="Stok Produk">
                                            @error('stok_produk')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number"
                                                ...
                                                name="berat_produk" value="{{ $produk->berat }}" placeholder="50000">
                                            @error('berat_produk')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="mb-3">
                                            ...
                                            <input id='input_mask_currency' name="harga_produk"
                                                ...
                                                type="text" value="{{ $produk->harga_produk }}" placeholder="Harga Produk">
                                            @error('harga_produk')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        ...
                                        <img id="output1" src="/produk/{{ $produk->foto_produk }}" class="img-fluid" />
                                    </div>
                                    <div class="col-sm-4">
                                        ...
                                        is-invalid
                                    @enderror"
                                            accept="image/*" id="imgInp1" value="{{ $produk->foto_produk }}">
                                        @error('img1')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror

                                        <input type="text" name="foto_lama" value=" {{ $produk->foto_produk }} " id="" hidden>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <textarea
                                            ...
                                            is-invalid
                                        @enderror"
                                            id="basic-conf" name="deskripsi_produk" placeholder="Tulis Deskripsi Produk">{{ $produk->deskripsi_produk}}</textarea>
                                ...
                                <div class="mt-3">
                                    <button type="submit" class="btn btn-primary w-100">Perbaharui Produk</button>
                                </div>
                            </form>
