        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="mb-0" action="{{ route('alamat.update', $alamat->id_alamat) }}" method="POST"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama"
                                            ...
                                            is-invalid
                                        @enderror"
                                            id="firstname" value="{{ $alamat->nama_penerima }}" placeholder="Nama Penerima">
                                        @error('nama')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="default" class="form-control @error('provinsi') is-invalid @enderror"
                                            ...
                                            @foreach ($provinsi as $provinsi)
                                                <option
                                                    value="{{ $provinsi['province_id'] . '|' . $provinsi['province'] }}" {{ $provinsi['province_id'] == $alamat->id_provinsi ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="default1" class="form-control @error('kota') is-invalid @enderror"
                                            ...
                                            @foreach ($city as $city)
                                                <option value="{{ $city['city_id'] . '|' . $city['city_name'] }}" {{ $city['city_id'] == $alamat->id_kota ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label my-2">Kode Pos <small
                                                class="text-danger font-13">*</small></label>
                                        <input type="number" value="{{ $alamat->kode_pos }}" name="kode_pos"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label my-2">Nomor Telp<small
                                                class="text-danger font-13">*</small></label>
                                        <input type="number" value="{{ $alamat->no_telp }}" name="telp"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="alamat"
                                            ...
                                            id="" cols="5" rows="5" placeholder="Alamat Lengkap">{{ $alamat->alamat_lengkap }}</textarea>
                                        @error('alamat')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <button type="submit" class="btn btn-primary w-100">Perbaharui Alamat Pengiriman</button>
                        </form>
                    </div>
                </div>
            </div>
